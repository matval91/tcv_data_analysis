...
print('Got ne '+r'\tcv_shot::top.results.thomson.profiles.auto:ne')
...
ti = te_s.data()
ti_t = te_s.getDimensionAt(0).data()
ti_rho = te_s.getDimensionAt(1).data()
expdata[1] = {'x': ti_rho, \
              'y': ti, \
              't': ti_t,\
              'ylab':r'T$_i$ (keV)'\
              }
print('Got ti '+r'\tcv_shot::top.results.cxrs.proffit:ti')
